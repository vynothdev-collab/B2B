  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-gray-600">
        ...
        technologies, and more — then lets you unlock individual contact fields as needed.
      ...
      <Section id="quick-example" title="Quick Example">
        ...
        <CodeBlock label="cURL">{`curl -X POST https://api.leadsbuddy.ai/public/v1/persons/search \\
