...
function ConnectionCard({
  ...
  if (loading) {
    return (
      <div className="flex h-full items-center gap-4 rounded-2xl border border-gray-100 bg-white p-5">
...
export default function IntegrationsClient() {
  ...
  const connectedCount = [sfConnected, hsConnected, zhConnected, inConnected, srConnected].filter(Boolean).length;
  const totalCount = 5;
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="inline-flex shrink-0 items-center gap-2 self-start rounded-full border border-gray-100 bg-gray-50 px-3.5 py-2 text-sm font-semibold text-gray-600 sm:self-auto">
              <span className={`h-2 w-2 rounded-full ${connectedCount > 0 ? "bg-emerald-500" : "bg-gray-300"}`} />
...
function ZohoLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 1024 450" className={className}>
      ...
      <path fill="#FFFFFF" d="M317,436.2l24.8-36.6h-20.4c-1.1,0-2-0.9-2-2v-4.9c0-1.1,0.9-2,2-2h33.5c1.1,0,2,0.9,2,2v1.9c0,0.4-0.1,0.8-0.3,1.1l-24.3,36.6h21.8c1.1,0,2,0.9,2,2v4.9c0,1.1-0.9,2-2,2h-35.4c-1.1,0-2-0.9-2-2v-1.8C316.6,436.9,316.8,436.5,317,436.2z" />
      <path fill="#FFFFFF" d="M421.4,415.6c0-15,11-25.8,26-25.8c15.5,0,26,10.6,26,25.9c0,15.5-10.7,26.2-26.2,26.2C431.6,441.9,421.4,431.2,421.4,415.6z M461.5,415.8c0-9.1-4.4-16.9-14.3-16.9c-10,0-13.8,8.1-13.8,17.3c0,8.7,4.7,16.7,14.3,16.7C457.6,432.8,461.5,424.3,461.5,415.8z" />
      <path fill="#FFFFFF" d="M544.5,390.6h7.4c1.1,0,2,0.9,2,2v18.6h21v-18.6c0-1.1,0.9-2,2-2h7.4c1.1,0,2,0.9,2,2v46.5c0,1.1-0.9,2-2,2H577c-1.1,0-2-0.9-2-2v-18.8h-21v18.8c0,1.1-0.9,2-2,2h-7.4c-1.1,0-2-0.9-2-2v-46.5C542.5,391.5,543.4,390.6,544.5,390.6z" />
      <path fill="#FFFFFF" d="M655.4,415.6c0-15,11-25.8,26-25.8c15.5,0,26,10.6,26,25.9c0,15.5-10.7,26.2-26.2,26.2C665.6,441.9,655.4,431.2,655.4,415.6z M695.4,415.8c0-9.1-4.4-16.9-14.3-16.9c-10,0-13.8,8.1-13.8,17.3c0,8.7,4.7,16.7,14.3,16.7C691.5,432.8,695.4,424.3,695.4,415.8z" />
    </svg>
  );
}
...
function SmartreachLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 1000 1000" className={className}>
      ...
      <circle fill="#FFCD00" mask="url(#smartreach-mask-2)" cx="671.428571" cy="328.571429" r="114.285714" />
    </svg>
  );
}
