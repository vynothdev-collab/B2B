  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center overflow-y-auto px-3 py-6 text-center sm:px-8 sm:py-16">
      <div className="flex flex-col items-center -mb-4">
        ...
        >
          <g filter="url(#filter0_dii_280_16168)">
            <path
              d="M34 54C34 36.3269 48.3269 22 66 22C83.6731 22 98 36.3269 98 54C98 71.6731 83.6731 86 66 86C48.3269 86 34 71.6731 34 54Z"
              fill="url(#paint0_radial_280_16168)"
            />
          </g>
          <defs>
            <filter
              id="filter0_dii_280_16168"
              x="0"
              y="0"
              width="132"
              height="132"
            ...
            >
              ...
              <feColorMatrix
                type="matrix"
                values="0 0 0 0 0.909804 0 0 0 0 0.25098 0 0 0 0 0.0627451 0 0 0 0.38 0"
              />
              <feBlend
                mode="normal"
                in2="BackgroundImageFix"
                result="effect1_dropShadow_280_16168"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_280_16168"
                result="shape"
              />
              <feColorMatrix
                in="SourceAlpha"
              ...
              <feBlend
                mode="normal"
                in2="shape"
                result="effect2_innerShadow_280_16168"
              />
              <feColorMatrix
                in="SourceAlpha"
                type="matrix"
              ...
              <feColorMatrix
                type="matrix"
                values="0 0 0 0 0.909804 0 0 0 0 0.25098 0 0 0 0 0.0627451 0 0 0 0.4 0"
              />
              <feBlend
                mode="normal"
                in2="effect2_innerShadow_280_16168"
                result="effect3_innerShadow_280_16168"
              />
            </filter>
            <radialGradient
              id="paint0_radial_280_16168"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(55.76 39.92) rotate(-90) scale(62.5107)"
            >
      ...
      <p className="mt-1 text-xs text-gray-500 sm:text-base">
        ...
        <span className="font-semibold text-red-600">LeadsBuddy AI</span>{" "}
        surfaces the best matches in seconds
      </p>
