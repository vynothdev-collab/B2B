    ...
    <div className="flex flex-col gap-2">
      ...
      <div>
        ...
        <CheckList
          ...
          onToggle={(v) => onChange({ companyStatus: toggle(filters.companyStatus, v) })}
        />
      </div>
      ...
      <div>
        ...
        <CheckList
          ...
          onToggle={(v) => onChange({ companyType: toggle(filters.companyType, v) })}
        />
      </div>
      ...
      <div>
        ...
        <CheckList
          ...
          onToggle={(v) => onChange({ companyHowTheySell: toggle(filters.companyHowTheySell, v) })}
        />
      </div>
      ...
      <div>
        ...
        <CheckList
          ...
          onToggle={(v) => onChange({ companyMoreFlags: toggle(filters.companyMoreFlags, v) })}
        />
      </div>
      ...
      <div>
        ...
        <CheckList
          ...
          onToggle={(v) => onChange({ companyRevenueModel: toggle(filters.companyRevenueModel, v) })}
        />
      </div>
    </div>
  );
