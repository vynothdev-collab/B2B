"use client";
import { FUNDING_PRESETS } from "@/types/search";
...
const inputCls =
  "w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-[12px] text-gray-800 placeholder-gray-400 focus:border-red-400 focus:outline-none sm:border-2";
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        <span
          className={
            mode === "predefined" ? "text-red-700 font-medium" : "text-gray-700"
          }
        >
          Predefined range
        </span>
      ...
      >
        ...
        <span
          className={
            mode === "custom" ? "text-red-700 font-medium" : "text-gray-700"
          }
        >
          Custom range
        </span>
