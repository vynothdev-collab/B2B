...
export default function CompanyTypeBusinessFilter({ filters, onChange }: Props) {
  return (
    <div className="flex flex-col gap-2.5">
      {/* Company Status */}
      <div>
        <p className="mb-1 text-[10px] font-semibold uppercase tracking-wide text-gray-400">Company Status</p>
        <div className="flex flex-col gap-0.5">
      ...
      <div>
        <p className="mb-1 text-[10px] font-semibold uppercase tracking-wide text-gray-400">Company Type</p>
        <IndustryMultiSelect
          values={filters.type}
