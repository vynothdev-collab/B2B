    ...
    <div>
      ...
      <div className="flex gap-1.5">
        ...
        <button
          ...
          title="Bulk add"
          className="flex shrink-0 items-center gap-1 rounded-lg border border-gray-200 bg-white px-2 text-[11px] font-semibold text-gray-600 transition-colors hover:bg-gray-50"
        >
      ...
      {bulkOpen && (
        <div className="mt-2 rounded-lg border border-gray-200 bg-white p-2">
          <textarea
            ...
            className="block min-h-[76px] w-full resize-y rounded-md bg-gray-50 px-2 py-1.5 text-[12px] text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400/50"
          />
          <div className="mt-2 flex justify-end gap-1.5">
            ...
            <button
              type="button"
              onClick={applyBulk}
              className="rounded-md bg-red-600 px-3 py-1 text-[12px] font-semibold text-white hover:bg-red-500"
            >
              Add all
            </button>
          </div>
